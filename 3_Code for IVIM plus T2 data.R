...
setwd("C:/Users/223024351/Desktop/Customer Data/2_Hunan Oncol/Jian_Lian/RC analysis/Part 3")



dt_sel <- read_csv('Total.csv')     ###%>% select(-c(1:3))
...
dt_man <- tibble(P = utest_res1$p.values, SNP = names(utest_res1$p.values), 
                 BP = c(1:42, 1:108, 1:226, 1:20, 1:42, 1:108, 1:226, 1:20), 
                 CHR = c(rep(1, 42), rep(2, 108), rep(3, 226), rep(4, 20),
                         rep(1, 42), rep(2, 108), rep(3, 226), rep(4, 20)))
#                                                                
